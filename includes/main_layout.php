        ...
        <div class="d-flex flex-column justify-content-between h-100 pb-3">
            <ul class="nav nav-pills flex-column mt-3">
                ...
                <?php
                    ...
                    elseif($_SESSION['role'] == 'siswa') $dashboard_link = "../projek_pkl/dashboard.php";
                ?>
                <li class="nav-item">
                ...
                <?php if ($_SESSION['role'] == 'guru'): ?>
                    ...
                    <li class="nav-item">
                        <a href="guru/absensi.php" class="nav-link">
                            <i class="bi bi-calendar-check"></i> Absensi Siswa
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="guru/tambah_materi.php" class="nav-link">
                            <i class="bi bi-file-earmark-plus"></i> Tambah Materi
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="guru/tambah_kuis.php" class="nav-link">
                            <i class="bi bi-clipboard-check"></i> Bank Soal
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="guru/lihat_nilai.php" class="nav-link">
                ...
                <?php if ($_SESSION['role'] == 'siswa'): ?>
                    <li class="nav-item"><span class="text-white-50 small px-3 mt-2">MENU SISWA</span></li>
                    <li class="nav-item">
                        <a href="siswa/materi.php" class="nav-link">
                            <i class="bi bi-journal-text me-2"></i> Materi Belajar
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="siswa/kuis.php" class="nav-link">
                            <i class="bi bi-pencil-square me-2"></i> Kerjakan Kuis
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="siswa/forum_diskusi.php" class="nav-link">
                            <i class="bi bi-chat-dots me-2"></i> Forum Diskusi
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="siswa/riwayat_absensi.php" class="nav-link">
                            <i class="bi bi-calendar-event me-2"></i> Riwayat Absensi
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="siswa/rekap_nilai.php" class="nav-link">
                            <i class="bi bi-bar-chart-line me-2"></i> Laporan Nilai
                        </a>
                    </li>
                <?php endif; ?>
